      ...
      <main className="flex-1 max-w-4xl mx-auto w-full px-4 py-8">
        ...
        {loading ? (
          <div className="flex items-center justify-center py-20">
            <div className="w-8 h-8 rounded-full border-2 border-t-transparent animate-spin" style={{ borderColor: '#05A854', borderTopColor: 'transparent' }}/>
          </div>
        ) : results.length === 0 ? (
                ...
                <div className="flex items-start justify-between gap-4">
                  <div className="flex-1">
                    ...
                    <div className="flex items-center gap-3 text-xs text-gray-500 mb-3">
                      {journal.issn && <span className="font-mono" style={{ color: '#05A854' }}>{formatISSN(journal.issn)}</span>}
